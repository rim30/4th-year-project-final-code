...
[X,s,Y]=define_pca_med(r1,r2,r3,r4,r5,r6,r7,r8,r9,r10,r11,r12,r13,r14,r15,r16,r17,r18,outchoice,windowlength);
...
ks=SVMModel18.KernelParameters.Scale;

kconst=2;

%SVMModel1 = fitcsvm(mX,Y(1,:),'Standardize',true,'KernelFunction',kernelfunc,'KernelScale',kconst*ks,'BoxConstraint',boxconstr); %build svm model
 %SVMModel2 = fitcsvm(mX,Y(2,:),'Standardize',true,'KernelFunction',kernelfunc,'KernelScale',kconst*ks,'BoxConstraint',boxconstr); %build svm model
% SVMModel3 = fitcsvm(mX,Y(3,:),'Standardize',true,'KernelFunction',kernelfunc,'KernelScale',kconst*ks,'BoxConstraint',boxconstr); %build svm model
% SVMModel4 = fitcsvm(mX,Y(4,:),'Standardize',true,'KernelFunction',kernelfunc,'KernelScale',kconst*ks,'BoxConstraint',boxconstr); %build svm model
 %SVMModel5 = fitcsvm(mX,Y(5,:),'Standardize',true,'KernelFunction',kernelfunc,'KernelScale',kconst*ks,'BoxConstraint',boxconstr); %build svm model
 %SVMModel6 = fitcsvm(mX,Y(6,:),'Standardize',true,'KernelFunction',kernelfunc,'KernelScale',kconst*ks,'BoxConstraint',boxconstr); %build svm model
 %SVMModel7 = fitcsvm(mX,Y(7,:),'Standardize',true,'KernelFunction',kernelfunc,'KernelScale',kconst*ks,'BoxConstraint',boxconstr); %build svm model
% SVMModel8 = fitcsvm(mX,Y(8,:),'Standardize',true,'KernelFunction',kernelfunc,'KernelScale',kconst*ks,'BoxConstraint',boxconstr); %build svm model
% SVMModel9 = fitcsvm(mX,Y(9,:),'Standardize',true,'KernelFunction',kernelfunc,'KernelScale',kconst*ks,'BoxConstraint',boxconstr); %build svm model
% SVMModel10 = fitcsvm(mX,Y(10,:),'Standardize',true,'KernelFunction',kernelfunc,'KernelScale',kconst*ks,'BoxConstraint',boxconstr); %build svm model
 %SVMModel11 = fitcsvm(mX,Y(11,:),'Standardize',true,'KernelFunction',kernelfunc,'KernelScale',kconst*ks,'BoxConstraint',boxconstr); %build svm model
% SVMModel12 = fitcsvm(mX,Y(12,:),'Standardize',true,'KernelFunction',kernelfunc,'KernelScale',kconst*ks,'BoxConstraint',boxconstr); %build svm model
% SVMModel13 = fitcsvm(mX,Y(13,:),'Standardize',true,'KernelFunction',kernelfunc,'KernelScale',kconst*ks,'BoxConstraint',boxconstr); %build svm model
 %SVMModel14 = fitcsvm(mX,Y(14,:),'Standardize',true,'KernelFunction',kernelfunc,'KernelScale',kconst*ks,'BoxConstraint',boxconstr); %build svm model
 %SVMModel15 = fitcsvm(mX,Y(15,:),'Standardize',true,'KernelFunction',kernelfunc,'KernelScale',kconst*ks,'BoxConstraint',boxconstr); %build svm model
% SVMModel16= fitcsvm(mX,Y(16,:),'Standardize',true,'KernelFunction',kernelfunc,'KernelScale',kconst*ks,'BoxConstraint',boxconstr); %build svm model
 %SVMModel17 = fitcsvm(mX,Y(17,:),'Standardize',true,'KernelFunction',kernelfunc,'KernelScale',kconst*ks,'BoxConstraint',boxconstr); %build svm model
 SVMModel18 = fitcsvm(mX,Y(18,:),'Standardize',true,'KernelFunction',kernelfunc,'KernelScale',kconst*ks,'BoxConstraint',boxconstr); %build svm model
...
predictions1=predict(SVMModel18,Ytest1);
...
final_matrix(k)=falsepos1;
end
end

final_matrix=final_matrix*100;
final_matrix
xlswrite('C:\Engineering part IIB\4th year project\Excel data\SVM\SVM_med_one_out.xlsx',final_matrix,2,'S5')